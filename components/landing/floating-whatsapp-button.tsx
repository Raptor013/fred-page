  ...
  return (
    ...
    >
      <span className="relative flex h-14 w-14 items-center justify-center sm:h-16 sm:w-16">
        <span className="whatsapp-ring absolute inset-[-8px] rounded-full border border-[#ff003c]/50" />
        <span className="whatsapp-ring whatsapp-ring-delay absolute inset-[-14px] rounded-full border border-[#ff003c]/30" />

        <span className="whatsapp-float relative flex h-full w-full items-center justify-center rounded-full border border-[#ff003c]/65 bg-black/88 text-[#ff003c] shadow-[0_0_18px_rgba(255,0,60,0.42),0_0_36px_rgba(255,0,60,0.2)] backdrop-blur-sm">
          ...
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
            className="whatsapp-icon relative h-7 w-7 fill-current sm:h-8 sm:w-8"
          >
