...
export function FloatingWhatsAppButton({
  ...
  return (
    <a
      ...
      className={`fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full border border-[#ff003c]/65 bg-black/88 text-[#ff003c] shadow-[0_0_18px_rgba(255,0,60,0.42),0_0_36px_rgba(255,0,60,0.2)] backdrop-blur-sm transition-all duration-300 sm:bottom-6 sm:right-6 sm:h-16 sm:w-16 ${
        visible
